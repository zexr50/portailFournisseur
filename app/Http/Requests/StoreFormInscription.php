...
class StoreFormInscription extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'fournisseur.no_rue' => 'required|string|max:8|regex:/^[0-9]{,8}$/',
            'fournisseur.rue' => 'required|string|max:8|regex:/^[a-zA-Z0-9]+$/',
            'fournisseur.no_bureau' => 'nullable|string|max:64|regex:/^[a-zA-Z0-9]{,8}$/',
            'fournisseur.ville' => 'required|string|max:64|regex:/^[a-zA-Z0-9]+$/',
            ...
            'fournisseur.code_postal' => 'required|string|max:6|regex:/^[a-zA-Z0-9]{6}$/',
